...
export function Footer() {
  return <footer id="footer" className="bg-gray-800 text-white p-6 flex flex-col lg:flex-row md:flex-row sm:flex-col justify-between items-center space-y-6 md:space-y-0">
